...
; browserify_shim__define__module__export__(typeof paper != "undefined" ? paper : window.paper);
...
exports.changeColor = function (event) {
  this.fillColor = '#cd807f';
};

exports.resetColor = function (event) {
  this.fillColor = '#9fc4cc';
};
